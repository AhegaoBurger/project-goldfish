...
__export(versioned_exports, {
  VersionChangeCap: () => VersionChangeCap,
  Versioned: () => Versioned
});
...
function Versioned() {
  return import_bcs.bcs.struct("Versioned", {
    id: object.UID(),
    version: import_bcs.bcs.u64()
  });
}
function VersionChangeCap() {
  return import_bcs.bcs.struct("VersionChangeCap", {
    versioned_id: import_bcs.bcs.Address,
    old_version: import_bcs.bcs.u64()
  });
}
