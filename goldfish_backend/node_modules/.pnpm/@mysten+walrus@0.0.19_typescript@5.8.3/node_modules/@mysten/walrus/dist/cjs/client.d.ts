...
import type { CertifyBlobOptions, DeleteBlobOptions, ExtendBlobOptions, GetBlobMetadataOptions, GetSliversOptions, GetStorageConfirmationOptions, GetVerifiedBlobStatusOptions, ReadBlobOptions, RegisterBlobOptions, SliversForNode, StorageWithSizeOptions, WalrusClientConfig, WalrusClientExtensionOptions, WriteBlobAttributesOptions, WriteBlobOptions, WriteEncodedBlobOptions, WriteEncodedBlobToNodesOptions, WriteMetadataOptions, WriteSliverOptions, WriteSliversToNodeOptions } from './types.js';
export declare class WalrusClient {
     ...
     * ```
     */
    createStorage({ size, epochs, walCoin, owner }: StorageWithSizeOptions): Promise<(tx: Transaction) => import("@mysten/sui/transactions").TransactionResult>;
    /**
     ...
     * ```
     */
    registerBlob({ size, epochs, blobId, rootHash, deletable, walCoin, owner, attributes, }: RegisterBlobOptions): Promise<(tx: Transaction) => import("@mysten/sui/transactions").TransactionResult>;
    /**
     ...
     * ```
     */
    certifyBlob({ blobId, blobObjectId, confirmations, deletable }: CertifyBlobOptions): Promise<(tx: Transaction) => void>;
    /**
     ...
     * ```
     */
    certifyBlobTransaction({ transaction, blobId, blobObjectId, confirmations, deletable, }: CertifyBlobOptions & {
        transaction?: Transaction;
    }): Promise<Transaction>;
    /**
     ...
     * ```
     */
    deleteBlob({ blobObjectId }: DeleteBlobOptions): Promise<(tx: Transaction) => import("@mysten/sui/transactions").TransactionResult>;
    /**
     ...
     * ```
     */
    extendBlob({ blobObjectId, epochs, endEpoch, walCoin, owner }: ExtendBlobOptions): Promise<(_tx: Transaction) => void>;
    /**
     ...
     * ```
     */
    writeBlobAttributes({ blobObject, blobObjectId, attributes }: WriteBlobAttributesOptions): Promise<(tx: Transaction) => void>;
    /**
