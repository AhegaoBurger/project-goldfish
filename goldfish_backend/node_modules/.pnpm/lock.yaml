...
importers:
  ...
  .:
    dependencies:
      '@mysten/walrus':
        specifier: ^0.0.19
        version: 0.0.19(typescript@5.8.3)
...
packages:
  ...
  '@mysten/walrus-wasm@0.0.6':
    resolution: {integrity: sha512-rqXopgWqALp8jdVaHeW64P5I7MmzEGy8gCFbfzK8xGgWGpSjKtvVeHJ9EguRVOxALaYtDBVlmMPnoySJi+bLjA==}

  '@mysten/walrus@0.0.19':
    resolution: {integrity: sha512-xcN7tgz9fUdbjxz5e3/TIz9eZxJLfJxjZlQejYP5MdiD6jqM5Gr0nM6af1IF9gBRpx6N3IHmw0U29M+11oMm8Q==}
...
snapshots:
  ...
  '@mysten/sui@1.28.2(typescript@5.8.3)':
    dependencies:
      '@graphql-typed-document-node/core': 3.2.0(graphql@16.11.0)
      '@mysten/bcs': 1.6.0
      '@mysten/utils': 0.0.0
  ...
  '@mysten/walrus@0.0.19(typescript@5.8.3)':
    dependencies:
      '@mysten/bcs': 1.6.0
      '@mysten/sui': 1.28.2(typescript@5.8.3)
      '@mysten/utils': 0.0.0
